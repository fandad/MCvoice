...
```text
mc26/build/libs/mcvoice-0.2.6+26.x.jar
mc12111/build/libs/mcvoice-0.2.6+1.21.11.jar
mc1218/build/libs/mcvoice-0.2.6+1.21.8.jar
mc1211/build/libs/mcvoice-0.2.6+1.21.1.jar
```

`mcvoice-0.2.6+26.x.jar` 覆盖 26.1、26.1.1、26.1.2 和 26.2；`1.21.11`、`1.21.8`、`1.21.1` 各自独立。
